...
function ShowToast(type,icon,title,content,delay) {
  ...
  function ShowMess(icon,title,content,delay, sub) {
    toast.Toast.show({
      type: 'info',
      icon: icon,
      title: title,
